    ...
    <section id="doctors" className="py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-3xl mx-auto">
          <p className="uppercase tracking-[0.34em] text-xs font-semibold text-brand.deep/80">Doctors</p>
          <h2 className="mt-5 text-4xl md:text-5xl font-semibold text-brand.ink">Meet your care team</h2>
          <p className="mt-4 text-brand.ink/70 text-lg">Premium specialists focused on balance, comfort, and measurable progress.</p>
        </div>
